    ...
    <nav class="bg-white shadow">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex">
                ...
                <img class="block lg:hidden h-8 w-auto" src="../../assets/logo-01.png" alt="Workflow">
                <img class="hidden lg:block h-24 w-auto" src="../../assets/logo-01.png" alt="Workflow">
                </div>
            ...
            <div class="flex items-center">
                ...
                <button type="button" class="relative inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-full text-white bg-indigo-600 shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                ...
                <div class="ml-3 relative">
                    <div>
                    <button type="button" class="bg-white rounded-full flex text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" id="user-menu-button" aria-expanded="false" aria-haspopup="true" @click="showMenu = !showMenu">
                    ...
                    <a href="#" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-1">Settings Desktop</a>
